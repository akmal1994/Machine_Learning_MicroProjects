...
#### Machine Learning
   ...
   4. [**Sales Prediction:**](https://github.com/akmal1994/Machine_Learning_MicroProjects/blob/main/ML-Supervised-Learning/Sales%20Prediction%20(Regression).ipynb) Regression based problem of book stall, where we need to predict/forecast the sales based on genres on the given day of a week.
